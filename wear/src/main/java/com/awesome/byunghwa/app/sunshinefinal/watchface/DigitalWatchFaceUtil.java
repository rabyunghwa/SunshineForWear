...
package com.awesome.byunghwa.app.sunshinefinal.watchface;
...
public final class DigitalWatchFaceUtil {
    ...
    /**
     * The {@link DataMap} key for {@link SunshineWeatherWatchFaceService} background color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    public static final String KEY_BACKGROUND_COLOR = "BACKGROUND_COLOR";

    /**
     * The {@link DataMap} key for {@link SunshineWeatherWatchFaceService} hour digits color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    public static final String KEY_HOURS_COLOR = "HOURS_COLOR";

    /**
     * The {@link DataMap} key for {@link SunshineWeatherWatchFaceService} minute digits color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    public static final String KEY_MINUTES_COLOR = "MINUTES_COLOR";

    /**
     * The {@link DataMap} key for {@link SunshineWeatherWatchFaceService} second digits color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    public static final String KEY_SECONDS_COLOR = "SECONDS_COLOR";

    /**
     * The path for the {@link DataItem} containing {@link SunshineWeatherWatchFaceService} configuration.
     */
    ...
    public static final String COLOR_NAME_INTERACTIVE_BACKGROUND = "Blue";
    public static final int COLOR_VALUE_INTERACTIVE_BACKGROUND =
            parseColor(COLOR_NAME_INTERACTIVE_BACKGROUND);
     ...
     * {@link SunshineWeatherWatchFaceService}.
     */
    ...
    /**
     * Asynchronously fetches the current config {@link DataMap} for {@link SunshineWeatherWatchFaceService}
